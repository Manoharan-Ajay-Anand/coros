...
addrinfo* coros::base::Server::get_local_addr_info() {
    int status;
    addrinfo* res;
    addrinfo hints = {};
...
void coros::base::Server::set_non_blocking(int socket_fd) {
...
void coros::base::Server::on_socket_event(bool can_read, bool can_write) {
    if (!can_read) {
